 ...
 * @author GL
 */
public class LinkErrorController extends BasicErrorController {

	public LinkErrorController(ErrorAttributes errorAttributes, ErrorProperties errorProperties) {
