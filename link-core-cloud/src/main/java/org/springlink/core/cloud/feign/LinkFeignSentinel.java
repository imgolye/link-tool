...
import org.springlink.core.cloud.sentinel.LinkSentinelInvocationHandler;
 ...
 */
public class LinkFeignSentinel {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new LinkSentinelInvocationHandler(target, dispatch, new FallbackFactory.Default(fallbackInstance));
					}
					if (void.class != fallbackFactory) {
						...
						return new LinkSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					// 默认fallbackFactory
					LinkFallbackFactory linkFallbackFactory = new LinkFallbackFactory(target);
					return new LinkSentinelInvocationHandler(target, dispatch, linkFallbackFactory);
				}
