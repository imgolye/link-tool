...
import org.springlink.core.tool.utils.StringPool;
...
public class LinkFileUtil {
	 ...
	 * @return LinkFile
	 */
	public static LinkFile getFile(MultipartFile file) {
	 ...
	 * @return LinkFile
	 */
	public static LinkFile getFile(MultipartFile file, String dir) {
	 ...
	 * @return LinkFile
	 */
	public static LinkFile getFile(MultipartFile file, String dir, String path, String virtualPath) {
		return new LinkFile(file, dir, path, virtualPath);
	}
	 ...
	 * @return LinkFile
	 */
	public static List<LinkFile> getFiles(List<MultipartFile> files) {
	 ...
	 * @return LinkFile
	 */
	public static List<LinkFile> getFiles(List<MultipartFile> files, String dir) {
	 ...
	 * @return Link File
	 */
	public static List<LinkFile> getFiles(List<MultipartFile> files, String dir, String path, String virtualPath) {
		List<LinkFile> list = new ArrayList<>();
		for (MultipartFile file : files) {
			list.add(new LinkFile(file, dir, path, virtualPath));
		}
		return list;
	}
