...
import org.springlink.core.tool.utils.ImageUtil;
 ...
 * @author GL
 */
public class LinkFileProxyFactory implements IFileProxy {
	...
	public String[] path(File f, String dir) {
		...
		return new String[]{LinkFileUtil.formatUrl(uploadPath.toString()), LinkFileUtil.formatUrl(virtualPath.toString())};
	}
