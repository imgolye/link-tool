 ...
 */
package org.springlink.develop.support;
...
import org.springlink.develop.constant.DevelopConstant;
...
public class LinkCodeGenerator {
	 ...
	 * 代码所在服务名
	 */
	private String serviceName = "link-service";
	/**
	 * 代码生成的包名
	 */
	private String packageName = "org.springlink.test";
	/**
	 * 代码后端生成的地址
	 */
	 ...
	 * 需要去掉的表前缀
	 */
	private String[] tablePrefix = {"link_"};
	/**
	 * 需要生成的表名(两者只能取其一)
	 */
	private String[] includeTables = {"link_test"};
	/**
	 * 需要排除的表名(两者只能取其一)
	 */
	...
	public void run() {
		...
		if (hasSuperEntity) {
			strategy.setSuperEntityClass("org.springlink.core.mp.base.BaseEntity");
			strategy.setSuperEntityColumns(superEntityColumns);
			strategy.setSuperServiceClass("org.springlink.core.mp.base.BaseService");
			strategy.setSuperServiceImplClass("org.springlink.core.mp.base.BaseServiceImpl");
		} else {
			strategy.setSuperServiceClass("com.baomidou.mybatisplus.extension.service.IService");
			strategy.setSuperServiceImplClass("com.baomidou.mybatisplus.extension.service.impl.ServiceImpl");
		}
		// 自定义 controller 父类
		strategy.setSuperControllerClass("org.springlink.core.boot.ctrl.LinkController");
	...
	public String getOutputDir() {
		return (Func.isBlank(packageDir) ? System.getProperty("user.dir") + "/link-ops/link-develop" : packageDir) + "/src/main/java";
	}
